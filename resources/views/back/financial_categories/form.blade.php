            ...
            <form class="" id="form" enctype="multipart/form-data">
                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    <div class="row row-xs">                 
                      <div class="col-12">
                        <label for="IncomeCatName">التصنيف</label>
                        <i class="fas fa-star require_input"></i>
                        <div>
                            <input type="text" class="form-control dataInput" placeholder="التصنيف" id="IncomeCatName" name="IncomeCatName" value="">
                        </div>
                        <bold class="text-danger" id="errors-IncomeCatName" style="display: none;"></bold>
                      </div>    
                    </div>
                </div>

...
@section('footer')
    ...
    @include('back.types_of_education.add')
    @include('back.types_of_education.edit')
@endsection
...
@section('content')
    <div class="container-fluid">
        ...
        @include('back.types_of_education.form')
                    ...
                    <table class="table table-bordered table-striped table-hover text-center text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">نوع التعليم</th>

...
@section('footer')
    <script>
        ...
        $('.modal').on('hidden.bs.modal', function(){
            $('form [id^=errors]').text('');
            $('form #TeacherID').selectize()[0].selectize.clear();
            $("#TheAmount").val(0);
        });
        ...
        // start when change TheAmount
        //$(document).on('input', '#TheAmount', function () {
        //    let amount = parseFloat($(this).val()) || 0;

        //    if (amount > 0) {
        //        $("#TheAmount").attr('class', 'text-success form-control');
        //    } else if (amount < 0) {
        //        $("#TheAmount").attr('class', 'text-danger form-control');
        //    }
        //});
        // end when change TheAmount
    ...
    @include('back.teacher_salaries.add')
    @include('back.teacher_salaries.edit')
    @include('back.teacher_salaries.delete')
...
@section('content')
    <div class="container-fluid">
        ...
        @include('back.teacher_salaries.form')
                    ...
                    <table class="table table-responsive table-bordered table-striped table-hover text-center text-md-nowrap" id="example1" style="max-height: 70vh; overflow: auto;">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th class="border-bottom-0 nowrap_thead" style="width: 180px !important;min-width: 180px !important;">المدرس</th>                                
                                <th class="border-bottom-0 nowrap_thead" style="width: 70px !important;min-width: 70px !important;">نوع الدفعة</th>
                                ...
                                <th class="border-bottom-0 nowrap_thead" style="width: 200px !important;min-width: 200px !important;">ملاحظات</th>
                                <th class="border-bottom-0 nowrap_thead" style="width: 120px !important;min-width: 120px !important;">المحغظة</th>

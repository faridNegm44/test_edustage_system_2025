<script>
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                if(res.noEdit){
                    ...
                    const TeacherID = $('#TeacherID')[0].selectize;
                    TeacherID.setValue(res.TeacherID);
    
                    flatpickr("#TheDate", {
                        defaultDate: res.TheDate
                    });    
    ...
    $(".modal #update").click(function(e){
        ...
        document.querySelector('.modal  .spinner_request2').setAttribute("style", "display: inline-block;");
        ...
        $.ajax({
            ...
            error: function(res){
                ...
                document.querySelector('.modal  .spinner_request2').style.display = 'none';                

...
@section('content')
    ...
    {{-- <div class="progress">
        <div class="progress-bar bg-secondary" role="progressbar" style="width: 10%;" aria-valuenow="1" aria-valuemin="0" aria-valuemax="100">1</div>
        <div class="progress-bar bg-secondary" role="progressbar" style="width: 10%;" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100">2</div>
        <div class="progress-bar bg-success" role="progressbar" style="width: 10%;" aria-valuenow="3" aria-valuemin="0" aria-valuemax="100">3</div>
        <div class="progress-bar bg-success" role="progressbar" style="width: 10%;" aria-valuenow="4" aria-valuemin="0" aria-valuemax="100">4</div>
        <div class="progress-bar bg-success" role="progressbar" style="width: 10%;" aria-valuenow="5" aria-valuemin="0" aria-valuemax="100">5</div>
        <div class="progress-bar bg-success" role="progressbar" style="width: 10%;" aria-valuenow="6" aria-valuemin="0" aria-valuemax="100">6</div>
        <div class="progress-bar bg-success" role="progressbar" style="width: 10%;" aria-valuenow="7" aria-valuemin="0" aria-valuemax="100">7</div>
        <div class="progress-bar bg-secondary" role="progressbar" style="width: 10%;" aria-valuenow="8" aria-valuemin="0" aria-valuemax="100">8</div>
        <div class="progress-bar bg-secondary" role="progressbar" style="width: 10%;" aria-valuenow="9" aria-valuemin="0" aria-valuemax="100">9</div>

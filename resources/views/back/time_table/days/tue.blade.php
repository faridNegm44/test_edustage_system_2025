                                            ...
                                            @foreach ($tueClassesUserOne as $tueOne)
                                                @if ($room->roomId == $tueOne->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTable::where('group_to_colspan', $tueOne->group_to_colspan)->count() }}"
                                            ...
                                            @foreach ($tueClassesUserTwo as $tueTwo)
                                                @if ($room->roomId == $tueTwo->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTable::where('group_to_colspan', $tueTwo->group_to_colspan)->count() }}"

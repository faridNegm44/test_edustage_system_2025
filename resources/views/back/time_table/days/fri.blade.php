                                            ...
                                            @foreach ($friClassesUserOne as $friOne)
                                                @if ($room->roomId == $friOne->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTable::where('group_to_colspan', $friOne->group_to_colspan)->count() }}"
                                            ...
                                            @foreach ($friClassesUserTwo as $friTwo)
                                                @if ($room->roomId == $friTwo->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTable::where('group_to_colspan', $friTwo->group_to_colspan)->count() }}"

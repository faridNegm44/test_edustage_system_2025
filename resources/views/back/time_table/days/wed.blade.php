                                            ...
                                            @foreach ($wedClassesUserOne as $wedOne)
                                                @if ($room->roomId == $wedOne->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTable::where('group_to_colspan', $wedOne->group_to_colspan)->count() }}"
                                            ...
                                            @foreach ($wedClassesUserTwo as $wedTwo)
                                                @if ($room->roomId == $wedTwo->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTable::where('group_to_colspan', $wedTwo->group_to_colspan)->count() }}"

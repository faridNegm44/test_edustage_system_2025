                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    <div class="row row-xs">                 
                      <div class="col-12">
                        ...
                        <div>
                            <input type="text" class="form-control dataInput" placeholder="اسم المحفظة" id="WalletName" name="WalletName" value="">
                        </div>
                        <bold class="text-danger" id="errors-WalletName" style="display: none;"></bold>
                      </div>    
                    </div>
                </div>

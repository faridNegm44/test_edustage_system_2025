    ...
    <div class="container">
        ...
        <div>
            <table class="table table-bordered table-striped text-center" style="font-size: 12px;">
                <thead class="">
                    <tr>
                        <th class="text-center" style="width: 33.3%;">اجمالي الجروبات</th>
                        <th class="text-center" style="width: 33.3%;">عدد الجروبات التي تم تقيمها لهذا الشهر</th>
                        <th class="text-center" style="width: 33.3%;">متبقي</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="font-weight: bold;font-size: 15px;">{{ $allGroups }}</td>
                        <td style="font-weight: bold;font-size: 20px;">{{ count($groupsRated) }}</td>
                        <td style="font-weight: bold;font-size: 15px;">{{ $allGroups - count($groupsRated) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div>
            <table class="table table-bordered table-striped table-hover" style="font-size: 12px;"> 
                ...
                <tbody style="font-size: 11px;">
                    @foreach ($unratedGroups as $group)
                        <tr>

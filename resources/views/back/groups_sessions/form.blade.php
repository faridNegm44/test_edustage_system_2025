            ...
            <form class="" id="form" enctype="multipart/form-data">
                ...
                <div class="bg-info-transparent" style="padding: 15px 30px !important;">
                    <div class="row row-xs">                 
                      <div class="col-12">
                        <label for="TheDate">تاريخ الحصة</label>
                        <i class="fas fa-star require_input"></i>
                        <div>
                          <input type="text" class="form-control datePicker dataInput text-center" placeholder="تاريخ الحصة" id="TheDate" name="TheDate" value="">

        ...
        $(document).ready(function () {
            ...
            $('#example1').DataTable({
                ...
                columns: [
                    ...
                    {data: 'LangType', name: 'LangType'},
                    {data: 'TheColor', name: 'TheColor'},
                ...
                lengthMenu: [[100, 200, -1], [100, 200, "الكل"]]
            });
        });
    </script>

    {{-- add, edit, delete => script --}}
    @include('back.subjects.add')
    @include('back.subjects.edit')
@endsection

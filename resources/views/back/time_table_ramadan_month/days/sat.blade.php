                                            ...
                                            @foreach ($satClassesUserOne as $satOne)
                                                @if ($room->roomId == $satOne->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTableRamadanMonth::where('group_to_colspan', $satOne->group_to_colspan)->count() }}"
                                            ...
                                            @foreach ($satClassesUserTwo as $satTwo)
                                                @if ($room->roomId == $satTwo->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTableRamadanMonth::where('group_to_colspan', $satTwo->group_to_colspan)->count() }}"

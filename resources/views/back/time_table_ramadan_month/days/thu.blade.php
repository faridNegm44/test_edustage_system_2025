                                            ...
                                            @foreach ($thuClassesUserOne as $thuOne)
                                                @if ($room->roomId == $thuOne->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTableRamadanMonth::where('group_to_colspan', $thuOne->group_to_colspan)->count() }}"
                                            ...
                                            @foreach ($thuClassesUserTwo as $thuTwo)
                                                @if ($room->roomId == $thuTwo->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTableRamadanMonth::where('group_to_colspan', $thuTwo->group_to_colspan)->count() }}"

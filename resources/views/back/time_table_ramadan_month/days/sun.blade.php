                                            ...
                                            @foreach ($sunClassesUserOne as $sunOne)
                                                @if ($room->roomId == $sunOne->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTableRamadanMonth::where('group_to_colspan', $sunOne->group_to_colspan)->count() }}"
                                            ...
                                            @foreach ($sunClassesUserTwo as $sunTwo)
                                                @if ($room->roomId == $sunTwo->room_id)
                                                    ...
                                                    <th
                                                        ...
                                                        data-count_colspan="{{ App\Models\Back\TimeTableRamadanMonth::where('group_to_colspan', $sunTwo->group_to_colspan)->count() }}"

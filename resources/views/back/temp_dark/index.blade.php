...
<!-- Mirrored from skote-v-dark.codeigniter.themesbrand.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Sep 2021 12:58:30 GMT -->
...
<!-- App favicon -->
<link rel="shortcut icon" href="{{ url('back' )}}/assets_dark/images/favicon.ico">

        <!-- Bootstrap Css -->
<link href="{{ url('back' )}}/assets_dark/css/bootstrap-dark.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
<!-- Icons Css -->
<link href="{{ url('back' )}}/assets_dark/css/icons.min.css" rel="stylesheet" type="text/css" />
<!-- App Css-->
<link href="{{ url('back' )}}/assets_dark/css/app-dark.min.css" id="app-style" rel="stylesheet" type="text/css" />
    </head>
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ url('back') }}/assets_dark/images/logo.svg" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url('back') }}/assets_dark/images/logo-dark.png" alt="" height="17">
                    </span>
                </a>

                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ url('back') }}/assets_dark/images/logo-light.svg" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url('back') }}/assets_dark/images/logo-light.png" alt="" height="19">
                    </span>
                </a>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="{{ url('back') }}/assets_dark/images/megamenu-img.png" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ url('back') }}/assets_dark/images/flags/us.jpg" alt="Header Language" height="16">                </button>
                <div class="dropdown-menu dropdown-menu-end">

                    <!-- item-->

                    <a href="http://localhost:8080/lang/en" class="dropdown-item notify-item language" data-lang="en">
                        <img src="{{ url('back') }}/assets_dark/images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                    </a>

                    <a href="http://localhost:8080/lang/es" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="{{ url('back') }}/assets_dark/images/flags/spain.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <a href="http://localhost:8080/lang/de" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="{{ url('back') }}/assets_dark/images/flags/germany.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>

                    <a href="http://localhost:8080/lang/it" class="dropdown-item notify-item language" data-lang="it">
                        <img src="{{ url('back') }}/assets_dark/images/flags/italy.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <a href="http://localhost:8080/lang/ru" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="{{ url('back') }}/assets_dark/images/flags/russia.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                    </a>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <div class="px-lg-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ url('back') }}/assets_dark/images/brands/github.png" alt="Github">
                                    <span>GitHub</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ url('back') }}/assets_dark/images/brands/bitbucket.png" alt="bitbucket">
                                    <span>Bitbucket</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ url('back') }}/assets_dark/images/brands/dribbble.png" alt="dribbble">
                                    <span>Dribbble</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ url('back') }}/assets_dark/images/brands/dropbox.png" alt="dropbox">
                                    <span>Dropbox</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ url('back') }}/assets_dark/images/brands/mail_chimp.png" alt="mail_chimp">
                                    <span>Mail Chimp</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ url('back') }}/assets_dark/images/brands/slack.png" alt="slack">
                                    <span>Slack</span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelleDBy="page-header-notifications-dropdown">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="#" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="{{ url('back') }}/assets_dark/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-grow-1">
                        ...
                        <a href="#" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="{{ url('back') }}/assets_dark/images/users/avatar-4.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ url('back') }}/assets_dark/images/users/avatar-1.jpg" alt="Header Avatar">
                                    ...
                                    <div class="bg-primary bg-soft">
                                        <div class="row">
                                            ...
                                            <div class="col-5 align-self-end">
                                                <img src="{{ url('back') }}/assets_dark/images/profile-img.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="avatar-md profile-user-wid mb-4">
                                                    <img src="{{ url('back') }}/assets_dark/images/users/avatar-1.jpg" alt="" class="img-thumbnail rounded-circle">
                                                </div>
                                    ...
                                    <table class="table align-middle table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <div>
                                                        <img src="{{ url('back') }}/assets_dark/images/product/img-7.png" alt="" class="avatar-sm">
                                                    </div>
                                                </th>
                                                <td>
                                                    <div>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div>
                                                        <img src="{{ url('back') }}/assets_dark/images/product/img-4.png" alt="" class="avatar-sm">
                                                    </div>
                                                </th>
                                                <td>
                                                    <div>
...
<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            <div class="mb-2">
                <img src="{{ url('back') }}/assets_dark/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="">
            </div>
            ...
            <div class="mb-2">
                <img src="{{ url('back') }}/assets_dark/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="">
            </div>
            <div class="form-check form-switch mb-3">
            ...
            <div class="mb-2">
                <img src="{{ url('back') }}/assets_dark/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="">
            </div>
            ...
            <div class="mb-2">
                <img src="{{ url('back') }}/assets_dark/images/layouts/layout-4.jpg" class="img-thumbnail" alt="layout images">
            </div>
            <div class="form-check form-switch mb-5">
...
<div class="rightbar-overlay"></div>
        <!-- JAVASCRIPT -->
<script src="{{ url('back') }}/assets_dark/libs/jquery/jquery.min.js"></script>
<script src="{{ url('back') }}/assets_dark/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="{{ url('back') }}/assets_dark/libs/metismenu/metisMenu.min.js"></script>
<script src="{{ url('back') }}/assets_dark/libs/simplebar/simplebar.min.js"></script>
<script src="{{ url('back') }}/assets_dark/libs/node-waves/waves.min.js"></script>
        <!-- apexcharts -->
        <script src="{{ url('back') }}/assets_dark/libs/apexcharts/apexcharts.min.js"></script>

        <!-- dashboard init -->
        <script src="{{ url('back') }}/assets_dark/js/pages/dashboard.init.js"></script>

        <!-- App js -->
        <script src="{{ url('back') }}/assets_dark/js/app.js"></script>
    </body>

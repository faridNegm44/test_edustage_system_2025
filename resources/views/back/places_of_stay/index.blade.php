...
@section('footer')
    ...
    <script>     
        ...
        $(document).ready(function () {
            ...
            $('#example1').DataTable({
                ...
                columns: [
                    {data: 'ID', name: 'ID'},
                    {data: 'TheCountry', name: 'TheCountry'},
                    {data: 'TheCity', name: 'TheCity'},
    ...
    @include('back.places_of_stay.add')
    @include('back.places_of_stay.edit')
@endsection
...
@section('content')
    <div class="container-fluid">
        ...
        @include('back.places_of_stay.form')

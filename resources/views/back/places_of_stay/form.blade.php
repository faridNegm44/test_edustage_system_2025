            ...
            <form class="" id="form" enctype="multipart/form-data">
                ...
                <div class="bg-info-transparent" style="padding: 15px 30px !important;">
                    <div class="row row-xs"> 
                      <div class="col-12">
                        <label for="TheCountry">الدولة</label>
                        <div>    
                            <select name="TheCountry" class="form-control TheCountry" id="TheCountry">
                              @foreach ($nats as $nat)
                                <option value="{{ $nat->TheName }}">{{ $nat->TheName }}</option>  
                              @endforeach
                            </select>
                        </div>
                        <bold class="text-danger" id="errors-TheCountry" style="display: none;"></bold>
                      </div> 

                      <div class="col-12">
                        <label for="TheCity">المدينة</label>
                        <i class="fas fa-star require_input"></i>
                        <div>
                            <input type="text" class="form-control dataInput" placeholder="المدينة" id="TheCity" name="TheCity">
                        </div>
                        <bold class="text-danger" id="errors-TheCity" style="display: none;"></bold>
                      </div>    

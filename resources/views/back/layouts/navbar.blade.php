    ...
    <div class="container-fluid">
        <div class="main-header-left">
            <div class="responsive-logo">
                <a href="{{ url('/') }}"><img src="{{ asset('back/images/settings/'.GeneralSettingsInfo()->logo_dashboard) }}" class="logo-1" alt="logo"></a>
                <a href="{{ url('/') }}"><img src="{{ asset('back/images/settings/'.GeneralSettingsInfo()->logo_dashboard) }}" class="dark-logo-1" alt="logo"></a>
                <a href="{{ url('/') }}"><img src="{{ asset('back/images/settings/'.GeneralSettingsInfo()->logo_dashboard) }}" class="logo-2" alt="logo"></a>
                <a href="{{ url('/') }}"><img src="{{ asset('back/images/settings/'.GeneralSettingsInfo()->logo_dashboard) }}" class="dark-logo-2" alt="logo"></a>
            </div>
            ...
            <div class="d-none d-lg-block" id="navbar_search_section" style="position: relative;">
                <div class="main-header-center mr-3 m-0 d-none d-lg-block" style="position: relative;">
                    <input id="navbar_input_search" class="form-control text-center font-weight-bold" placeholder="بحث عن حصة" type="search" style="width: 500px !important;border-radius: 0;height: 25px !important;">

                    <button class="btn" id="navbar_button_search" style="top: -6px;"><i class="fas fa-search d-none d-md-block"></i></button>

                    <div class="spinner-border text-danger" id="navbar_spinner" role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                </div>

                <div class="card d-none d-lg-block" id="navbar_search_time_table">
                    <table class="table table-bordered table-hover text-center">
                        <thead class="thead-dark">
                            <tr>
                                <th style="width: 10%;">الجروب</th>
                                <th style="width: 10%;">المدرس</th>
                                <th style="width: 10%;">اليوم</th>
                                <th style="width: 15%;">الوقت</th>
                                <th style="width: 20%;">نوع الحصة</th>
                                <th style="width: 15%;">غ / م</th>
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href="#"><img alt="" src="{{ asset('back') }}/images/users/{{ !$userInfoFromAdminTable ? 'df_image.png' : $userInfoFromAdminTable->image }}"></a>
                    <div class="dropdown-menu">

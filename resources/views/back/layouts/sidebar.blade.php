				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item text-light" href="111">كشف مدغوعات ولي أمر</a></li>
							<li><a class="slide-item text-light" href="1111">كشف تفقد</a></li>
							<li><a class="slide-item text-light" href="11111">كشف عام</a></li>
							<li><a class="slide-item text-light" href="22">لائحة الطلاب المسجلين</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item text-light" href="4">كشف مدفوعات المدرسين</a></li>

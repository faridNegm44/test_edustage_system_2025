...
class TimeTableReportsController extends Controller
{
    ...
    public function teacher_report_get(){
        $pageNameAr = 'تقرير حصص المدرسين';
        $pageNameEn = 'teacher_report';

        // $teachers = DB::table('tbl_groups')
        ...
        $teachers = DB::table('tbl_teachers')
                        ...
                        ->orderBy('TheName', 'Asc')
                        ->get();
        return view('back.time_table.teacher_report.index' , compact('pageNameAr' , 'pageNameEn', 'teachers'));
    }
    ...
    public function teacher_pdf()
    {
        ...
        if(count($teacherDetails) == 0){
            ...
            $nameAr = 'تقرير حصص لمدرس'.' - '.$teacherDetails[0]->teacherName;
            return view('back.time_table.teacher_report.pdf', compact('nameAr', 'teacherDetails'));
        }
    }
    ...
    public function groups_report_get(){
        ...
        return view('back.time_table.groups_report.index' , compact('pageNameAr' , 'pageNameEn', 'groups', 'tblYearsMat'));
    }
    ...
    public function groups_pdf(Request $request)
    {
        ...
        $groupsDetails = DB::table('time_tables')
        ...
        if(count($groupsDetails) == 0){
            ...
            return view('back.time_table.groups_report.pdf', compact('nameAr', 'groupsDetails', 'countReqGroup'));
        }
    }
    ...
    public function groups_not_rated_report_get(){
        ...
        return view('back.time_table.groups_not_rated_report.index' , compact('pageNameAr' , 'pageNameEn', 'groups', 'tblYearsMat'));
    }
    ...
    public function groups_not_rated_pdf(Request $request)
    {
        ...
        if(count($groupsDetails) == 0){
            ...
            $nameAr = 'تقرير حصص الجروبات';
            return view('back.time_table.groups_not_rated_report.pdf', compact('nameAr', 'groupsDetails', 'countReqGroup'));
        }
    }

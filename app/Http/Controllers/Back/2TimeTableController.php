    ...
    public function store(Request $request)
    {
        if (request()->ajax()){
            $this->validate($request , [
                'group_id' => 'required',
                'times' => 'required',
                'date' => auth()->user()->user_status == 4 ? 'required|date|after_or_equal:today' : 'nullable',
            ],[
                    ...
                    DB::transaction(function(){
                        ...
                        for($i = 0; $i < count(request('times')); $i++){
                            $data[] = [
                                ...
                                'date' => request('date'),
                                'day' => request('day'),
                                'class_type' => auth()->user()->user_status == 4 ? 'تعوضية' : request('class_type'),
                        ...
                        TimeTableHistory::create([
                            ...
                            'class_type_time' => auth()->user()->user_status == 4 ? 'تعوضية' : request('class_type'),
